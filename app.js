...
async function query0(_fiscalCode, _referenceDate) {
	try {
		var r = "";
		if (_fiscalCode === "" || _referenceDate === "") {
		...
		const query = { fiscalCode: new RegExp(_fiscalCode)}; //'MRNVTR79P49A479Q'
		...
		let referenceDate = new Date(_referenceDate); // Represents the current time and date
...
async function query3(_vaccineLot) {
	try {
		...
		const database = client.db('covid_data');
		const certificates = database.collection('covid_certificate');
		const query = { "vaccines.lot" : new RegExp(_vaccineLot) }; //"OXF000904"
...
async function command1(_c1Fiscal, _c1idVax, _c1Lot, _c1Type, _c1Brand, _c1Prod, _c1When, _c1Where) {
	try {
		var r = "";
		if (_c1Fiscal === "" || _c1idVax === "" || _c1Lot === "" || _c1Type === "" || _c1Brand === "" || _c1Prod === "" || _c1When === "" || _c1Where === "") {
			r = "Some fields are missing.";
			return r;
		}
		// Connect to DB and prepare query
		...
		const update = { $push: {vaccines: {idVax: _c1idVax, lot: _c1Lot, type: _c1Type, brand: _c1Brand, productionDate: new Date(_c1Prod), when: new Date(_c1When), where: _c1Where }}, $set: { "current.idVax": _c1idVax, "current.lot": _c1Lot, "current.type": _c1Type, "current.brand": _c1Brand, "current.productionDate": new Date(_c1Prod), "current.when": new Date(_c1When), "current.where": _c1Where, issueDate: new Date(_c1When), "authorizedBody.idBody": "8431", "authorizedBody.name": "Diagnostic Center", "authorizedBody.description": "A simple diagnostic center.", "authorizedBody.location": "('45.78068', '12.84043')", "authorizedBody.entityType": "Hospital", "authorizedBody.department": "234", "authorizedBody.address": "Via Address, 2", "authorizedBody.city": "Milano", personnel: [{fiscalCode: "test", job: "Doctor"},{fiscalCode: "test2", job: "Nurse"}]}};
...
async function command2(_c2Fiscal, _c2Name, _c2Surname, _c2Gender, _c2Address, _c2City, _c2Phone, _c2Email, _c2Emergency, _c2Date, _c2Res) {
	try {
		var r = "";
		if (_c2Fiscal === "" || _c2Name === "" || _c2Surname === "" || _c2Gender === "" || _c2Address === "" || _c2City === "" || _c2Phone === "" || _c2Email === "" || _c2Emergency === "" || _c2Date === "" | _c2Res === "") {
		r = "Some fields are missing.";
		return r;
		}
		// Connect to DB and prepare query
		...
		const database = client.db('covid_data');
		const certificates = database.collection('covid_certificate');
		const insert = {idCertificate: _idCounter++, issueDate: new Date(_c2Date), fiscalCode: _c2Fiscal, name: _c2Name, surname: _c2Surname, gender: _c2Gender, address: _c2Address, city: _c2City, phoneNumber: _c2Phone, email: _c2Email, emergencyContact: _c2Emergency, current: {idTest: "01000", result: _c2Res, when: new Date(_c2Date), where: "('45.79377', '8.88104')"}, tests: [{idTest: "01000", result: _c2Res, when: new Date(_c2Date), where: "('45.79377', '8.88104')"}], personnel:[{fiscalCode: "MNCGCM33E18I480U", job: "doctor"}], authorizedBody: {idBody: "9999", name: "test", description: "test", location: "('45.79377', '8.88104')", entityType: "Hospital", department: "DPM5972", address: "Vicolo Strada Cianciolo, 4", city: "Malnate"}};
...
app.post('/c1', urlencodedParser, (req, res) => {
    ...
    command1(_c1Fiscal, _c1idVax, _c1Lot, _c1Type, _c1Brand, _c1Prod, _c1When, _c1Where).then(function(result) {
        var box = result;
        res.render('home', {
            post:{
                outDiv_command1: box
...
var _c2Res = req.body.c2_result;
    command2(_c2Fiscal, _c2Name, _c2Surname, _c2Gender, _c2Address, _c2City, _c2Phone, _c2Email, _c2Emergency, _c2Date, _c2Res).then(function(result) {
        var box = result;
        res.render('home', {
            post:{
                outDiv_command2: box
